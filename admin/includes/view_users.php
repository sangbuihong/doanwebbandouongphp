...
if (isset($_GET['delete_user'])) {
    $deletekh = "delete from khachhang where MSKH='$_GET[delete_user]";
    $deletekh = mysqli_query($con, $deletekh);
    $deletekhdn = "delete from khachhangdangnhap where MSKH='$_GET[delete_user]'";
    $deletekhdn = mysqli_query($con, $deletekhdn);
  if ($deletekh & $deletekhdn) {
