...
if (isset($_POST['change_password'])) {
    ...
    $select_password = mysqli_query($conn, "select * from khachhangdangnhap where passwordkh='$hash_current_password' and MSKH='$_SESSION[user_id]' ");
    ...
    if (mysqli_num_rows($select_password) == 0) {
        ...
        $update = mysqli_query($conn, "update khachhangdangnhap set passwordkh='$hash_new_password' where MSKH='$_SESSION[user_id]' ");
