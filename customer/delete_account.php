...
if (isset($_POST['yes'])) {
  ...
  $delete_account_2 = mysqli_query($conn, "delete from khachangdangnhap where MSKH='$_SESSION[user_id]' ");


  $delete_account_1 = mysqli_query($conn, "delete from khachhang where MSKH='$_SESSION[user_id]' ");
